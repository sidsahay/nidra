...
void
AnimatedCharacter::UpdateMatrices(const glm::mat4 &P, const glm::mat4 &V, const glm::mat4 &M, const glm::mat4 &MVP) {
...
void AnimatedCharacter::UpdateBones() {
    data.UpdateBones();
    glUniformMatrix4fv(buffers.boneXformArrayID, static_cast<GLsizei>(data.boneTransforms.size()), GL_FALSE,
                       &data.boneTransforms[0][0][0]);
}
